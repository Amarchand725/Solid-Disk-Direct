        ...
        <div class="card mb-4">
            <div class="row">
                ...
                @if (request()->is($routeInitialize.'/trashed'))
                    ...
                    @endcan
                @else
                    @canany([$routeInitialize.'-create', $routeInitialize.'-import', $routeInitialize.'-trashed'])
                        <div class="col-md-8">
                            <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                                ...
                                @can($routeInitialize.'-import')
                                    <button
                                        id="add-btn"
                                        data-toggle="tooltip" data-placement="top" title="Import {{ $singularLabel }}"
                                        ...
                                        <span>
                                            ...
                                            <span class="d-none d-sm-inline-block"> Import {{ $singularLabel }} </span>
                                        </span>
                                    </button>
                                @endcan
