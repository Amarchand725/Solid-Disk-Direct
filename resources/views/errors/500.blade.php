...
@section('title',  ($exception->getStatusCode() ?? 'Unknown'). '-'. 'Internal Server Error')
@section('content')
    <!-- Not Authorized -->
    ...
    <div class="misc-wrapper">
      <h2 class="mb-1 mt-4">Internal Server Error</h2>
      ...
      <div class="mt-4">
        <img
            src="{{ asset('admin') }}/assets/img/illustrations/page-misc-you-are-not-authorized.png"
