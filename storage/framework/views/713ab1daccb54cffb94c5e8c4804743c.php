                        ...
                        <div class="col-md-8">
                            <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($routeInitialize.'-trashed')): ?>
                                    <a data-toggle="tooltip" data-placement="top" title="All Trashed Records" href="<?php echo e(route($routeInitialize.'.trashed')); ?>" class="btn btn-label-danger mx-1">
                                        <span>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Solid-Disk-Direct\Solid-Disk-Direct\resources\views/admin/shipping_methods/index.blade.php ENDPATH**/ ?>