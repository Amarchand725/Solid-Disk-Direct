    ...
    <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td>
                ...
                <?php else: ?>
                    <?php if($name=='product'): ?>
                        <img src="<?php echo e(asset('storage/' . $model->hasProduct->thumbnail)); ?>" class="zoomable" width="40">
                        <?php echo e($model->hasProduct->title); ?>
...
<?php /**PATH C:\xampp\htdocs\Solid-Disk-Direct\Solid-Disk-Direct\resources\views/admin/recent_view_products/show_content.blade.php ENDPATH**/ ?>