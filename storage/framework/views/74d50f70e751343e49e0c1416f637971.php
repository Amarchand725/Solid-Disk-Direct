        ...
        <div class="card mb-4">
            <div class="row">
                ...
                <?php if(request()->is($routeInitialize.'/trashed')): ?>
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any([$routeInitialize.'-create', $routeInitialize.'-import', $routeInitialize.'-trashed'])): ?>
                        <div class="col-md-8">
                            <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($routeInitialize.'-import')): ?>
                                    <button
                                        id="add-btn"
                                        data-toggle="tooltip" data-placement="top" title="Import <?php echo e($singularLabel); ?>"
                                        ...
                                        <span>
                                            ...
                                            <span class="d-none d-sm-inline-block"> Import <?php echo e($singularLabel); ?> </span>
                                        </span>
                                    </button>
                                <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Solid-Disk-Direct\Solid-Disk-Direct\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>