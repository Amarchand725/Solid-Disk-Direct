    ...
    <?php if($name != 'created_at'): ?>
        <div class="col-12 mb-3">
                ...
                <?php if($name=='parent'): ?>
                    <select id="<?php echo e($name); ?>" name="<?php echo e($name); ?>" class="form-control">
                        ...
                        <?php $__currentLoopData = $parent_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $parent_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($parent_category->id); ?>" <?php echo e($parent_category->id==$field['value']?'selected':''); ?>>
            ...
            <?php elseif(isset($field['type']) && $field['type'] === 'textarea'): ?>
                <textarea id="<?php echo e($name); ?>" name="<?php echo e($name); ?>" class="form-control" placeholder="<?php echo e($field['placeholder'] ?? ''); ?>"><?php echo old($name, $field['value'] ?? ''); ?></textarea>
...
</script><?php /**PATH C:\xampp\htdocs\solid-dis-direct\backend\resources\views/admin/categories/edit_content.blade.php ENDPATH**/ ?>