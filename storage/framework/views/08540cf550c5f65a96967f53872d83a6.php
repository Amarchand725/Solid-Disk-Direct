        ...
        <div class="card mb-4">
            <div class="row">
                ...
                <?php if(request()->is($routeInitialize.'/trashed')): ?>
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any([$routeInitialize.'-trashed', $routeInitialize.'-import', $routeInitialize.'-create'])): ?>
                        <div class="col-md-8">
                            <div class="dt-buttons btn-group flex-wrap float-end mt-4">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Solid-Disk-Direct\Solid-Disk-Direct\resources\views/admin/brands/index.blade.php ENDPATH**/ ?>