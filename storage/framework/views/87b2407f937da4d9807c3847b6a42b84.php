    ...
    <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td>
                ...
                <?php else: ?>
                    <?php if($name=='parent' && isset($model->hasParent) && !empty($model->hasParent)): ?>
                        <?php echo e($model->hasParent->name ?? '-'); ?>
...
<?php /**PATH C:\xampp\htdocs\solid-dis-direct\backend\resources\views/admin/categories/show_content.blade.php ENDPATH**/ ?>