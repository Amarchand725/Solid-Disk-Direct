        ...
        <div class="col-md-6 col-xl-4 mb-4">
            ...
            <div class="card-body">
                ...
                <li class="d-flex mb-4 pb-1">
                    <div class="me-3">
                    <img src="<?php echo e(asset('admin')); ?>/assets/img/products/iphone.png" alt="User" class="rounded" width="46" />
                    </div>
                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                ...
                <li class="d-flex mb-4 pb-1">
                    <div class="me-3">
                    <img
                        src="<?php echo e(asset('admin')); ?>/assets/img/products/nike-air-jordan.png"
                        alt="User"
                        class="rounded"
                        width="46"
                    />
                ...
                <li class="d-flex mb-4 pb-1">
                    <div class="me-3">
                    <img src="<?php echo e(asset('admin')); ?>/assets/img/products/headphones.png" alt="User" class="rounded" width="46" />
                    </div>
                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                ...
                <li class="d-flex mb-4 pb-1">
                    <div class="me-3">
                    <img
                        src="<?php echo e(asset('admin')); ?>/assets/img/products/apple-watch.png"
                        alt="User"
                        class="rounded"
                        width="46"
                    />
                ...
                <li class="d-flex mb-4 pb-1">
                    <div class="me-3">
                    <img
                        src="<?php echo e(asset('admin')); ?>/assets/img/products/amazon-echo.png"
                        alt="User"
                        class="rounded"
                        width="46"
                    />
                ...
                <li class="d-flex">
                    <div class="me-3">
                    <img
                        src="<?php echo e(asset('admin')); ?>/assets/img/products/play-station.png"
                        alt="User"
                        class="rounded"
                        width="46"
                    />
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Solid-Disk-Direct\Solid-Disk-Direct\resources\views/admin/dashboards/dashboard.blade.php ENDPATH**/ ?>