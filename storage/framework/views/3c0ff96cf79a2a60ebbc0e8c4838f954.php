        ...
        <tr>
            ...
            <td>
                ...
                <?php elseif($name === 'status'): ?>
                    <span class="badge bg-label-<?php echo e($model->status ? 'success' : 'warning'); ?>">
                        <?php echo e($model->status ? 'Process' : 'Pending'); ?>
...
<?php /**PATH C:\xampp\htdocs\Solid-Disk-Direct\Solid-Disk-Direct\resources\views/admin/quote_requests/show_content.blade.php ENDPATH**/ ?>