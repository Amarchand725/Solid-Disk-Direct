...
<p>Customer: <?php echo e($customerName ?? 'N/A'); ?> | Total: <strong><?php echo e(currency()); ?><?php echo e($order->total_amount); ?></strong></p>
    ...
    <tbody>
        <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="product-row">
                ...
                <td><?php echo e($item->product->short_description); ?></td>
        ...
        <tr>
            ...
            <td>SubTotal</td>
            <td>
                <strong><?php echo e(currency()); ?> <span id="sub-total"><?php echo e(number_format($order->sub_total, 2)); ?></span></strong>
                <input type="hidden" name="sub_total_value" value="<?php echo e(number_format($order->sub_total, 2)); ?>">
            </td>
        </tr>
        <tr>
            <td colspan="5"></td>
            <td>Tax (%)</td>
            <td><input type="number" name="tax" class="form-control" value="<?php echo e($order->tax); ?>"></td>
        </tr>
        <tr>
            <td colspan="5"></td>
            <td>Shipping Charges</td>
            <td><input type="number" name="shipping_charges" class="form-control" value="<?php echo e($order->shipping_charges); ?>"></td>
        </tr>
        <tr>
            <td colspan="5"></td>
            <td>Grand Total</td>
            <td>
                <strong><?php echo e(currency()); ?> <span id="grand-total"><?php echo e(number_format($order->total_amount, 2)); ?></span></strong>
                <input type="hidden" name="grand_total_value" value="<?php echo e(number_format($order->total_amount, 2)); ?>">
            </td>
        </tr>
    </tbody>
</table>
...
<div class="mb-2">
    ...
    <select name="payment_method" id="payment_method" class="form-control">
        ...
        <option value="payarc" <?php echo e($order->payment_method=='payarc' ? 'selected' : ''); ?>>Payarc</option>
        <option value="stripe" <?php echo e($order->payment_method=='stripe' ? 'selected' : ''); ?>>Stripe</option>
    </select>
...
<div class="mb-2">
    ...
    <select name="vendor" id="vendor" class="form-control">
        ...
        <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($vendor->id); ?>" <?php echo e($order->vendor==$vendor->id?'selected':''); ?>><?php echo e($vendor->name); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
...
<div class="mb-2">
    ...
    <textarea name="warranty_info" id="" rows="5" class="form-control" placeholder="Enter warranty info"><?php echo e($order->warranty_info ?? null); ?></textarea>
    <span id="warranty_info_error" class="text-danger error"></span>
</div>
<br />
<div class="mb-2">
    <label>COMMENTS OR SPECIAL INSTRUCTIONS </label>
    <textarea name="notes" id="" rows="5" class="form-control" placeholder="Enter comment or special instructions"><?php echo e($order->notes ?? null); ?></textarea>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('input', '.qty-input, .price-input, input[name="tax"], input[name="shipping_charges"]', function () {
            updateGrandTotal();
        });
...
</script><?php /**PATH C:\xampp\htdocs\Solid-Disk-Direct\Solid-Disk-Direct\resources\views/admin/purchase_orders/edit_content.blade.php ENDPATH**/ ?>