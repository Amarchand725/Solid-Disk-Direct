    ...
    <?php if($name != 'created_at'): ?>
        <div class="col-12 mb-3">
            ...
            <?php if(isset($field['type']) && $field['type'] === 'select'): ?>
                <?php if($name=='category' && isset($categories) && !empty($categories)): ?>
                    <select id="<?php echo e($name); ?>" name="category" class="form-control">
...
</script><?php /**PATH C:\xampp\htdocs\Solid-Disk-Direct\Solid-Disk-Direct\resources\views/admin/banners/create_content.blade.php ENDPATH**/ ?>